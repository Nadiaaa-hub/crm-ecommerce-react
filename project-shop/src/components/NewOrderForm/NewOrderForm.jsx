            ...
            <form className="form" onSubmit={formik.handleSubmit}>
                ...
                <div className="client-box">
                    ...
                    <div className="input-box">
                        ...
                        {formik.touched.postOffice && formik.errors.postOffice ? <div className='error'>{formik.errors.postOffice}</div> : '' }
                    </div>
                    <div className="input-box">
                        Email:
                ...
                <div className="item-box">
                    ...
                    <div className="input-box">
                        ...
                        {formik.touched.titleOrder && formik.errors.titleOrder ? <div className='error'>{formik.errors.titleOrder}</div> : '' }
                    </div>
                    <div className="input-box">
                        Price:
                        <input 
                    ...
                    <div className="quantity-box">
                        ...
                        <button type="button" onClick={handleClickMore}>+</button>
                    ...
                    <div>
                        ...
                        {formik.touched.comment && formik.errors.comment ? <div className='error'>{formik.errors.comment}</div> : '' }
                    </div>
                    <div>
                        <h2>Total: {total}</h2>
                    </div>
                ...
                <div className="button-box">
                    ...
                    <button className="btn-close" type="button"onClick={handleCloseForm}>Close</button>
                </div>
